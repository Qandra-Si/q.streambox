...
#  GET /cache/tagged/killlist/?u=/alliance/99014727/ HTTP/1.1
#  Accept-Encoding: identity
#  Host: 127.0.0.1:80
#  User-Agent: Python-urllib/3.9
#  Connection: close
# заголовок, который отправляет curl (не блокируется cloudfare):
#  HEAD /cache/tagged/killlist/?u=/alliance/99014727/ HTTP/1.1
#  Host: 127.0.0.1
...
def run_server(server_class=HTTPServer, handler_class=HttpHandler, address='127.0.0.1', port=8085):
